...
function local_xf() {
//调用hello.js云端代码
    var first = require("../cloud/obql_updatefindContent.js").obql_updatefindContent;
    tool.test(first, {"app_key": options.app_key, "rest_key": options.rest_key,"findContentId":"3oCrTTTw"});
